...
void UI::Print(Queue<Action*> ActionListR, Queue<Action*> ActionListC, Queue<Order*> Pend_ODG,
	Queue<Order*> Pend_ODN, Queue<Order*> Pend_OT, Queue<Order*> Pend_OVN, Pending_OVC Pend_OVC,
	Queue<Order*> Pend_OVG, Queue<Order*> Ready_OT, Queue<Order*> Ready_OD, RDY_OV Ready_OV,
	Cook_Order Cooking_orders, Queue<Order*> Cancelled_Orders, Stack<Order*> Finished_Orders, 
	...
	Fit_Tables Free_Tables, Fit_Tables Busy_Sharable, Fit_Tables Busy_No_Share)
{
	...
	Pend_OT.print();
	Pend_OVN.print();
	Pend_OVC.print(); //need to be implemented
	Pend_OVG.print();
	cout << "/n=================Available Chefs IDs================/n";
	cout << Free_CS.getcount() << " ";
	Free_CS.print();
	cout << Free_CN.getcount() << " ";
	Free_CN.print();
	cout << "/n=================Cooking Orders [Orders ID, Chef ID]================/n";
	cout << Cooking_orders.getcount() << " ";
	Cooking_orders.print();
	cout << "/n=================Ready Orders IDs================/n";
	cout << Ready_OT.getcount()<< " ";
	Ready_OT.print();
	cout << Ready_OD.getcount() << " ";
	Ready_OD.print();
	cout << Ready_OV.getcount() << " ";
	Ready_OV.print();
